function rpsGame(yourChoice) {
    ...
    // console.log("You chooses: " + humanChoice);

    botChoice = numToChoice(randToRpsInt());
    // console.log("Computer chooses: " + botChoice);

    let results = decideWinner(humanChoice, botChoice);     // [0, 1] --> Human lost and computer lost
    // console.log(results);
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
    ...
    // Removes all the elements present previously
